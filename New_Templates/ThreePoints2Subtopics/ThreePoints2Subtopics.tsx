...
// Ports the 3 Points / 2 Subtopics V1 prototype:
...
export const threePoints2SubtopicsTimingsSchema = z
  .object({
...
export const threePoints2SubtopicsSchema = z.object({
...
export type ThreePoints2SubtopicsProps = z.infer<typeof threePoints2SubtopicsSchema>;

export const threePoints2SubtopicsMeta = {
  description:
...
export const ThreePoints2Subtopics: React.FC<ThreePoints2SubtopicsProps> = ({
  ...
  const [handle] = useState(() => delayRender('Loading ThreePoints2Subtopics fonts'));
  useEffect(() => {
    loadFonts()
