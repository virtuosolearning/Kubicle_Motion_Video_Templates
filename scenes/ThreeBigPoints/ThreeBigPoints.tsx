...
// Ports the media team's "3 Big Points v2" prototype:
...
export const threeBigPointsMeta = {
  description:
    'Three-column card with icon + pill label per column. A loading bar sweeps ' +
    'left-to-right while the icons appear, then the three pills pop in staggered.',
  authoringNotes:
