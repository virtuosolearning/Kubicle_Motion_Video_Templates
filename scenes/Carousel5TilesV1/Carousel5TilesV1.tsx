...
// Carousel5TilesV1 — 5-tile 3D coverflow carousel.
...
export const carousel5TilesV1TileSchema = z.object({
...
export const carousel5TilesV1TimingsSchema = z
  .object({
...
export const carousel5TilesV1Schema = z.object({
  tiles:   z.array(carousel5TilesV1TileSchema).length(5),
  timings: carousel5TilesV1TimingsSchema.optional(),
});

export type Carousel5TilesV1Props = z.infer<typeof carousel5TilesV1Schema>;

export const carousel5TilesV1Meta = {
  description:
...
function Tile({
  ...
  tile: z.infer<typeof carousel5TilesV1TileSchema>;
  slot: number;
}) {
...
export const Carousel5TilesV1: React.FC<Carousel5TilesV1Props> = ({
  tiles,
  timings,
}) => {
  const frame = useCurrentFrame();

  const [handle] = useState(() => delayRender('Loading Carousel5TilesV1 fonts'));
  useEffect(() => {
    loadFonts()
...
export const carousel5TilesV1DefaultProps: Carousel5TilesV1Props = {
  tiles: [
    {
      title: 'Prompt-First',
      icon:  'terminal',
