...
// Ports the 1 Point — 7 Subtopics prototype exactly:
...
export const onePoint7SubtopicsTimingsSchema = z
  .object({
...
export const onePoint7SubtopicsSchema = z.object({
  ...
  timings: onePoint7SubtopicsTimingsSchema.optional(),
});

export type OnePoint7SubtopicsProps = z.infer<typeof onePoint7SubtopicsSchema>;

export const onePoint7SubtopicsMeta = {
  description:
    'Split-screen slide: Oxford Blue right panel holds a header pill + six ' +
    'detail pills that type in sequentially (waterfall). Light-blue left panel ' +
    'shows a large line-art anchor icon. Best for one concept with 6 supporting details.',
  authoringNotes:
...
type AnchorProp = OnePoint7SubtopicsProps['anchor'];
...
export const OnePoint7Subtopics: React.FC<OnePoint7SubtopicsProps> = ({
  mainTitle,
  details,
  anchor,
  timings,
  ...
  const [handle] = useState(() => delayRender('Loading OnePoint7Subtopics fonts'));
  useEffect(() => {
    loadFonts()
...
export const onePoint7SubtopicsDefaultProps: OnePoint7SubtopicsProps = {
...
export const onePoint7SubtopicsCharacterDemoProps: OnePoint7SubtopicsProps = {
  ...onePoint7SubtopicsDefaultProps,
